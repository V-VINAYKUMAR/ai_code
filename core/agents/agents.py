...
class CoderAgent:
    SYSTEM_NEW = (
        ...
        "If the task requests a test file, follow the requested test framework "
        "and exact number of tests. "
        "Never redefine or copy the implementation being tested. "
        "Import the implementation from the source module instead. "
        "Do not add extra tests when the user specifies an exact number. "
    ...
    def _build_prompt(
        ...
        return (
            ...
            f"Previous results:\n{prev}\n\n"
            f"Memory:\n{memory}\n\n"
            "Write the complete implementation required by the task. "
